...
export function MangaPageShell({ children, className, footer, topbar }: Props) {
  return (
    <div
      className={cn(
        'border-manga-black bg-manga-paper text-manga-black relative mx-auto my-3 flex min-h-[calc(100vh-24px)] w-[min(1460px,calc(100%-24px))] flex-col overflow-hidden border-3 shadow-[8px_8px_0_var(--manga-black),18px_18px_0_var(--manga-shadow)] sm:my-4 sm:min-h-[calc(100vh-32px)] sm:w-[min(1460px,calc(100%-32px))]',
